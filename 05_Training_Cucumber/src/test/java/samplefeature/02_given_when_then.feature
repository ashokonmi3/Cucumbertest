...
#Objective/Description: To verify as a customer I can add an item to my shopping basket
#Precondition: User is logged in and on the product details page
#Steps: 1. User clicks on the Add to basket button
           #2. When the user remove the product from the basket
#Expected Restult: 1. The product is added in the basket
                              #2. The product is removed from the basket